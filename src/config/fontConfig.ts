...
export const fontsList: FontDefinition[] = [
	{
		name: "KaiXinJiuXiaoLinYuJiuZou",
		cssVariable: "--font-kaixin",
		provider: "local",
		options: {
			variants: [
				{
...
export const fontConfig: FontSelectionConfig = {
	...
	// 主页横幅副标题字体
	bannerSubtitleFont: "--font-kaixin",
	// 导航栏标题字体
	navbarTitleFont: "--font-kaixin",
	// 代码块字体
	codeFont: "--font-kaixin",
